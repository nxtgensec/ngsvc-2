...
// Social media icons as SVGs for better quality
...
const YouTubeIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
  </svg>;
const LinkedInIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
const WhatsAppIcon = () => <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <img src={nxtgensecLogo} alt="NxtGenSec Logo" className="w-12 h-12 object-contain" />
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((social, index) => <a key={index} href={social.href} aria-label={social.label} className="w-10 h-10 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/50 transition-all duration-300">
                  <social.icon />
                </a>)}
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:vibecoding@nxtgensec.org" className="font-inter text-sm text-muted-foreground hover:text-primary transition-colors duration-300">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://vibecoding.nxtgensec.org" target="_blank" rel="noopener noreferrer" className="font-inter text-sm text-muted-foreground hover:text-secondary transition-colors duration-300 flex items-center gap-1">
                  vibecoding.nxtgensec.org
                  <ExternalLink className="w-3 h-3" />
                </a>
              </li>
