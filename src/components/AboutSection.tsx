      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="font-orbitron text-3xl md:text-4xl font-bold mb-4">
            ...
            <span className="text-gradient-primary">VibeCoding?</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`group p-6 rounded-xl card-gradient border border-border hover:border-${feature.color}/50 transition-all duration-300 hover:glow-${feature.color}`}
            >
        ...
        <div className="mt-20 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: 'Students', emoji: '🎓', desc: 'School, college, or university students with a passion for coding.' },
              { title: 'Professionals', emoji: '💼', desc: 'Working professionals looking to showcase their skills and innovate.' },
              { title: 'Tech Enthusiasts', emoji: '💻', desc: 'Anyone with interest in technology and problem-solving.' },
            ].map((item, index) => (
              <div
                key={index}
