      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border">
              ...
              <span className="font-inter text-sm text-muted-foreground">Limited features without login</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 border border-secondary/30">
              <Lock className="w-4 h-4 text-secondary" />
              <span className="font-inter text-sm text-secondary">All premium features FREE with login</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {challenges.map((challenge, index) => (
            <div
              key={index}
              className={`group p-6 rounded-xl card-gradient border border-border hover:border-${challenge.color}/50 transition-all duration-500 hover:-translate-y-1`}
            >
